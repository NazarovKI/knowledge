...
Хорошо бы попытаться продвинуть при помощи https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=266&LESSON_ID=25516&LESSON_PATH=25398.25506.25512.25516 апи хотя бы на стадию "некачественный лид"
...
Этапы пишутся в совершенном виде, ключевые этапы вроде презентации и замера делятся на 2 колонки - назначен и проведен. На каждом этапе есть обязательные поля и обязательные задачи.
```mermaid
kanban

...
Нужен расчет : ЗАДАЧА — Тема Описание — Соберите информацию по запросу клиента для подготовки КП — Ответственный — Ответственный за сделку
```  
```mermaid
kanban
  ...
  column2[Подготовка КП]
    ...
    task2[Задача: ”Подготовьте и отправьте
КП для клиента” Ответственный: Ответственный за сделку]

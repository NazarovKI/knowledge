...
- [Квалификация лида](qualification.md)
- [Выявление потребности клиента](viyavlenie_potrebnosti.md)
- [Расчёт КП](raschot.md)
- [Замер](zamer_reglament.md)
- [Оформление договора](oformlenie_dogovora.md)
- Монтаж
Общая принадлежность процессов к более большому процессу "сделка", каждый имеет свои стадии. Воронка создаётся только для процессов в которых требуется оплата, где участвуют деньги.
...
Лид становится сделкой когда стало понятно, что это наш клиент. Лид квалифицирован как качественный. Во многих компаниях лид это просто намерение. Поэтому на воронке лидов минимум стадий, на ней важно только установление контакта и квалификация. Ответственный. Лиды у которых источник сайт ekb.oknaplastikovie.ru должны сразу попадать в сделки.
```mermaid 
--- 
config: 
  logLevel: 'debug' 
...
Лид квалифицирован : Создаем сделку с категориями: Коттедж : Квартира : Без монтажа — воронка : Создаем контакт : Создаем компанию 
